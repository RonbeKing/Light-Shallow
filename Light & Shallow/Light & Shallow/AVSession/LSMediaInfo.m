...
-(NSString *)description{
    ...
    NSString* descriptions = [NSString stringWithFormat:@"\n videoWidth = %f \n videoHeight = %f \n videoFrameRate = %f \n videoOutputBitrate = %f \n videoOrientation = %d \n videoDuration = %lld \n videoByte = %lld \n",self.videoWidth,self.videoHeight,self.videoFrameRate,self.videoOutputBitrate,self.videoOrientation,self.videoDuration.value/self.videoDuration.timescale,self.videoByte];
    return descriptions;
}
